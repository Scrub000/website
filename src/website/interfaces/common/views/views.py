...
from ....domain.blogs import queries as blog_queries
from ....domain.categories import queries as category_queries
from ..forms.main import forms
...
def before_request():
    ...
    if account.is_authenticated:
        account.update(seen_at=datetime.datetime.utcnow())
